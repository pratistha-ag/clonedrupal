 ...
 * @endcode
 */
$settings['hash_salt'] = 'OAPGcXmyd_pFcXVC4-q4oA-3763SVkZVSmOcdHoEfar9aPGZ2nuYsXLycVDxTZDO87DeKW8T0A';
...
$settings['config_sync_directory'] = 'sites/default/files/config_sFG06O5mdZzvM3pGuzkwTkWHrkMMiZN5WZhO_WBzurBFCU4LRb3q0Q_VQ2EGsd9ozI3f-TcdAw/sync';
// Configuration settings for stackabl
      if (file_exists(__DIR__ . '/stackabl.settings.php')) {
        include __DIR__ . '/stackabl.settings.php';
      }